...
//Peticion fetch al API
fetch('https://swapi.co/api/people/1/')
    //Primera promesa se trata como json
    .then(resp => resp.json())
    //Se obtiene el usuario y se obtiene lo que se desea saber
    .then(usuario =>{
        console.log(`El nombre del usuario es ${usuario.name}`);
        console.log(`Su genero es ${usuario.gender}`);
    });
...
fetch('https://swapi.co/api/people/1/')
    ...
    .then(usuario =>{
        ...
        return fetch('https://reqres.in/api/users', {
            ...
            body: JSON.stringify(usu), //que queremos mandar (Json en forma de string)
